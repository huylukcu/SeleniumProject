...
public class Day07_Alerts extends TestBase {
    ...
    public void acceptAlert() throws InterruptedException {
        ...
        Thread.sleep(2000);//system wait 2 sec
...
/*
---->What is Alert?
Alert are pop up that is generated by JavaScript.When ther is an alert we must handle the alerts.
Otherwise, we can not continue to the test execution
---->How do you handle alert?
First we can not inspect js alerts. We should first switch to the alert and use accept() to click ok,
dismiss() to click cancel,sendKeys()to type,getText() to get the text from alert

       driver.switchTo().alert.getText();sendKey()
                               accept();dismiss()
 */